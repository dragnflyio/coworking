...
var nicEditorInstance = bkClass.extend({
	...
	disable : function(x) {
		if(!x) x = 'false';
		this.elm.setAttribute('contentEditable',x);
	},
	...
	nicCommand : function(cmd,args) {
		if(!document.queryCommandState('styleWithCSS') && cmd.indexOf('font') == 0) document.execCommand('styleWithCSS', false, true);
...
var nicEditorAdvancedButton = nicEditorButton.extend({
	...
	addForm : function(f,elm) {
		...
		new bkElement('input').setAttributes({'type' : 'submit','value':'Save'}).setStyle({backgroundColor : '#efefef',border : '1px solid #ccc', padding:'2px', margin : '3px 0', 'float' : 'left', 'clear' : 'both'}).appendTo(this.form);
